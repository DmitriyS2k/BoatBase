...
<div class="card">
  ...
  <div class="help-row"><b>ch1/ch2</b><span>Прямое управление в режиме MANUAL (elevon mix на пульте)</span></div>
  <div class="help-row"><b>ch3</b><span>Круиз-контроль: если >1750 — включается удержание курса по компасу</span></div>
  <div class="help-row"><b>ch4</b><span>Подруливание в круиз-режиме (центр = держит курс, отклонение = ручной поворот)</span></div>
  <div class="help-row"><b>ch2 ≥1900</b><span>В режиме AUTO — старт движения к выбранной точке</span></div>
  <div class="help-row"><b>ch2 ≤1100</b><span>В режиме AUTO — старт возврата домой (точка 0)</span></div>
  <div class="help-row"><b>ch1 ≥1900</b><span>В режиме SAVE WP — сохранить текущую GPS позицию как выбранную точку</span></div>
</div>

<div class="card">
  <h2>PID автопилот — что крутить</h2>
  <p class="help-intro">PID управляет тем как корабль исправляет отклонение от курса. Настраивай на воде, начинай с Kp.</p>
  <div class="help-param">
    <div class="help-pname">Kp (пропорциональный)</div>
    <div class="help-pdesc">Основная сила поворота. <b>Слишком мало</b> — корабль медленно выходит на курс, постоянно плывёт чуть в сторону. <b>Слишком много</b> — рыскает влево-вправо вокруг курса, «виляет». Начни с 7.9, уменьши до 4-5 если виляет.</div>
  </div>
  <div class="help-param">
    <div class="help-pname">Ki (интегральный)</div>
    <div class="help-pdesc">Убирает постоянное смещение от курса (например от ветра или течения). <b>Слишком мало</b> — корабль стабильно плывёт, но всегда немного левее/правее курса. <b>Слишком много</b> — медленные нарастающие колебания. При настройке сначала выставь Ki=0, настрой Kp, потом добавляй Ki.</div>
  </div>
  <div class="help-param">
    <div class="help-pname">Kd (дифференциальный)</div>
    <div class="help-pdesc">Гасит колебания, предотвращает перерегулирование. <b>Слишком мало</b> — после поворота корабль «проскакивает» курс и долго раскачивается. <b>Слишком много</b> — дёргается, резко реагирует на шум компаса. Обычно хватает 0.1–0.5, не трогай если всё хорошо.</div>
  </div>
  <div class="help-param">
    <div class="help-pname">Скорость автопилота</div>
    <div class="help-pdesc">PWM тяга в режиме AUTO (1500=стоп, 1900=полный газ). Стартуй с 1600-1650. Слишком высокая скорость — корабль промахивается мимо точки из-за инерции.</div>
  </div>
  <div class="help-param">
    <div class="help-pname">Замедление перед точкой</div>
    <div class="help-pdesc"><b>С какого расстояния</b> — за сколько метров до точки начинать тормозить. <b>Скорость торможения</b> — до какого PWM замедляться (1530-1580 обычно). Корабль плавно снижает скорость от полной до минимальной на этом расстоянии. Если проскакивает точку — увеличь расстояние или снизь скорость торможения.</div>
  </div>
  <div class="help-param">
    <div class="help-pname">Радиус прибытия</div>
    <div class="help-pdesc">За сколько метров до точки считать «доехали» и останавливаться. GPS даёт точность ~3-5м, меньше этого ставить бессмысленно. Рекомендуется 3-5м.</div>
  </div>
</div>
...
<div class="card">
  ...
  <div class="help-param">
    <div class="help-pname">Коэффициент круиза (cruiseGain)</div>
    <div class="help-pdesc">Сила удержания курса в ручном круиз-режиме (ch3>1750). <b>Мало</b> — корабль медленно возвращается на курс после волны или ветра. <b>Много</b> — дёргается, постоянно корректирует. 1.0-2.0 обычно хорошо.</div>
  </div>
</div>

<div class="card">
  <h2>Trim моторов</h2>
  <p class="help-intro">Если на полном газе корабль уходит в сторону — это разброс ESC или винтов. Компенсируется trimом.</p>
  <div class="help-param">
    <div class="help-pname">Как настроить</div>
    <div class="help-pdesc">Выйди на воду, дай ~70% газа прямо без руля. Уходит вправо — увеличь trimLeft или уменьши trimRight. Уходит влево — наоборот. Trim применяется только при активном газе. Это улучшает и авто-режим — PID получает уже скомпенсированные моторы.</div>
  </div>
</div>
...
<div class="card">
  ...
  <ol class="help-steps">
    <li>Откалибруй компас (Настройки → Компас). Выбери правильную ось.</li>
    <li>Настрой trim моторов — поплыви прямо и убери уход в сторону.</li>
    <li>Проверь MANUAL режим — корабль слушается пульта нормально.</li>
    <li>Проверь круиз ch3>1750 — держит курс, ch4 подруливает.</li>
    <li>Сохрани точку «Дом» — выйди на середину, переключи SAVE WP, ch1≥1900.</li>
    <li>Настрой автопилот: скорость 1600, Kp=7.9, Ki=7.6, Kd=0.2 — это стартовые значения.</li>
    <li>Дай команду вернуться домой (AUTO + ch2≤1100). Смотри как едет.</li>
    <li>Виляет — уменьши Kp. Не выходит на курс — увеличь Kp. Постоянно в стороне — добавь Ki.</li>
